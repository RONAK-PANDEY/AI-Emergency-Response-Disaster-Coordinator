"""
analyze_emergency_image.py

Uses OpenAI's GPT-4o (vision-capable) to assess a single image for
visible emergency-relevant hazards and severity.
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 2:
        print("Usage: python analyze_emergency_image.py <image_path>")
        sys.exit(1)

    output = analyze_emergency_image(sys.argv[1])
