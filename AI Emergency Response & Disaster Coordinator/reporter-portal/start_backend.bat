@echo off
title Citizen Reporter Portal - Backend Server (FastAPI)
...
echo ============================================================
echo   CITIZEN REPORTER PORTAL - BACKEND SERVER
...
echo [INFO] Shared Database: incidents.db (Connected with Officer Portal)
